...
export default async function decorate(block) {
  ...
  // Controls strip below the image (dots + prev/next chevrons).
  // The WKND "mini" carousel renders these even for a single slide, so
  // they are always built to match the source appearance.
